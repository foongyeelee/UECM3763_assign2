...
data = DR("1961.KL",'yahoo',start,end)#Use DataReader to read the data from yahoo
print('3 years of daily data for 1961, IOI') 
print(data)

# Plot the 5-day moving average for IOI
ioi = DR("1961.KL",'yahoo',start,end)['Close'] # Use DataReader to read the close price
mov_avg = pd.rolling_mean(ioi,5) # Use the built in function in pandas to calculate the moving average
